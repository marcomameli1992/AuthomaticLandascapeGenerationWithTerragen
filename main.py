    ...
    for index, path in enumerate(files):
        ...
        for render_node_name in render_node_list:
            ...
            try:
                ...
                LOGGER.info(f' the file {path} has not the render mesh created')
            ...
            if 'windows' in platform.system().lower():
                ...
                tgp = folder_path.replace('files', 'terragen').replace("/" + folder_path.split('/')[-1],"")#terragen_command_path##'./terragen' #os.getenv('TERRAGEN_PATH')
